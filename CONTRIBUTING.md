# Contributing to blackroad-os-landing-worker
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-os-landing-worker.git
cd blackroad-os-landing-worker

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-os-landing-worker.git
